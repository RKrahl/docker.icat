...
RUN mkdir -p $GLASSFISH_HOME/apps && \
	...
	https://repo.icatproject.org/repo/org/icatproject/authn.oidc/1.1.0/authn.oidc-1.1.0-distro.zip \
	https://repo.icatproject.org/repo/org/icatproject/icat.server/5.0.3/icat.server-5.0.3-distro.zip \
	...
	https://repo.icatproject.org/repo/org/icatproject/ids.server/1.12.2/ids.server-1.12.2-distro.zip \
