...
RUN mkdir -p $GLASSFISH_HOME/apps && \
	...
	https://repo.icatproject.org/repo/org/icatproject/icat.server/4.7.0/icat.server-4.7.0-distro.zip \
	https://repo.icatproject.org/repo/org/icatproject/ids.storage_file/1.3.3/ids.storage_file-1.3.3-distro.zip \
	https://repo.icatproject.org/repo/org/icatproject/ids.server/1.6.0/ids.server-1.6.0-distro.zip \
	https://repo.icatproject.org/repo/org/icatproject/topcat/2.0.0/topcat-2.0.0-distro.zip; do \
